...
Il dataset è stato scaricato da Kaggle con nome "Flights and Airports Data"
...
Questo progetto analizza la rete aerea domestica degli Stati Uniti attraverso tecniche di **network analysis** e **data mining**, utilizzando un dataset Kaggle di oltre 2.5 milioni di voli commerciali e 358 aeroporti distribuiti nei primi 6 mesi dell'anno (Gennaio-Giugno). L'analisi si articola in quattro macro-aree principali:

**1. Analisi Topologica della Rete**: Utilizzando metriche di centralità (Degree, PageRank, Betweenness, Power Centrality), sono stati identificati gli hub critici del sistema aereo nazionale. Denver, Atlanta e Dallas emergono come aeroporti strategicamente insostituibili per la loro elevata **Betweenness Centrality**, fungendo da ponti obbligati per i collegamenti transcontinentali Est-Ovest. La visualizzazione interattiva con `visNetwork` consente l'esplorazione dinamica delle 1,478+ rotte più trafficate, evidenziando la struttura **scale-free** della rete dove pochi mega-hub concentrano la maggior parte del traffico.

**2. Analisi Pattern di Ritardi**: L'indagine sui ritardi alla partenza rivela pattern temporali ricorrenti fortemente correlati con fattori operativi e stagionali. Chicago (O'Hare e Midway) domina la classifica degli aeroporti problematici con ritardi medi di 16 minuti e il 30% dei voli oltre 15 minuti di ritardo, attribuibili a meteo difficile (neve da effetto lago), congestione cronica e infrastrutture obsolete. L'**analisi settimanale** dimostra che il venerdì registra il picco di ritardi per sovrapposizione di traffico business e leisure, mentre il sabato emerge come giorno più puntuale grazie al volume ridotto del 22% e alla minor congestione aeroportuale. L'**analisi mensile** rivela un ciclo operativo con picco al giorno 10 e miglioramento progressivo verso fine mese.

**3. Clustering Aeroporti per Efficienza Operativa**: Applicando **K-means clustering** (k=3 ottimale via metodo Silhouette) su 9 feature di puntualità standardizzate, sono emersi tre profili distinti: (1) **Cluster 1 "Mediamente Efficienti"** (34 aeroporti Costa Est/città medie, ritardo medio 9.4 min), (2) **Cluster 2 "Aeroporti Puntuali"** (21 aeroporti regionali/Costa Ovest, ritardo medio 6.5 min, SD=31 min - più prevedibili), (3) **Cluster 3 "Mega-Hub Congestionati"** (15 hub nazionali come Atlanta/Dallas/Denver, ritardo medio 13.3 min, 14% ritardi gravi ma miglior recupero in volo 4.7 min). L'analisi PCA conferma la netta separazione dei cluster, evidenziando il **trade-off connettività-puntualità**: i mega-hub soffrono congestione sistemica ma compensano con strategie di time recovery aggressive durante il volo.

**4. Robustezza della Rete agli Attacchi Mirati**: Implementando strategie di percolazione su 5 metriche di centralità diverse (Degree, PageRank, Betweenness statico/adattivo, Power Centrality), l'analisi dimostra che la rete aerea USA è una **rete scale-free robusta-ma-fragile**. La sovrapposizione iniziale delle curve (0-20 rimozioni) conferma l'alta ridondanza: rimuovere i primi 15-20 hub principali ha impatto limitato grazie a percorsi alternativi. Tuttavia, superata la **soglia critica** di ~25-30 nodi (35-40% della rete), il **Betweenness Adattivo** emerge come strategia più distruttiva, frammentando rapidamente la rete perché ricalcola dinamicamente i nuovi ponti critici ad ogni rimozione. Questo conferma che Denver, Atlanta e Dallas sono **nodi insostituibili** la cui compromissione simultanea causerebbe il collasso della connettività transcontinentale.
...
Nel grafo non vengono visti tutti gli aereoporti per una questione di visualizzazione, ossia si tiene conto delle rotte più importanti (numero di voli > di 1478) e non di quelle secondarie. 
